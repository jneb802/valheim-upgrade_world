...
public static class Helper
{
  ...
  public static List<ZDO>? GetZDOs(Vector2s zone)
  {
    ...
    // Sector zero also stores objects outside the normal world grid.
    objects.RemoveAll(zdo => ZoneSystem.GetZone(zdo.GetPosition()) != zone);
    return objects;
  }
  ...
  public static void MarkChanged(ZDO zdo)
  {
